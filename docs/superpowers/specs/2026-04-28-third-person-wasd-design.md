...
- a distância da câmera é suavizada e limitada entre cerca de 7 e 13 células/metros de jogo;
...
- manter distância suavizada com clamp entre `GAT_TILE_SIZE * 7.0` e `GAT_TILE_SIZE * 13.0`;
